...
class ManualConfig:
    SCHEDULER_PRIORITY = """
       Restart
       > RedeemCodes > Reward > Destroy > Mailbox > DailyGift > WeeklyGift > MonthlyGift > Commission > Shop > RubbishShop > Conversation > RookieArena > SimulationRoom > TribeTower > Event >  Daily > MissionPass > Liberation > NikkeSurvivors
       """
