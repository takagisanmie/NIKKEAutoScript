...
class ManualConfig:
    SCHEDULER_PRIORITY = """
       Restart
       > Reward > Destroy > DailyGift > WeeklyGift > MonthlyGift > Commission > Shop > RubbishShop > Conversation > RookieArena > SimulationRoom > TribeTower > Event >  Daily > MissionPass > Liberation
       """
